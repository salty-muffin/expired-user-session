...
@click.option("--whisper_dtype", type=str, default="float32",                     help="Torch dtype to use for the model (transformers: float32, float16; Ctranslate2: default, auto, int8, int8_float32, int8_float16, int8_bfloat16, int16, float16, float32, bfloat16)")
...
@click.option("--gpt_dtype", type=str, default="float32",                         help="Torch dtype to use for the model (transformers: float32, bfloat16; Ctranslate2: default, auto, int8, int8_float32, int8_float16, int8_bfloat16, int16, float16, float32, bfloat16)")
...
@click.option("--bark_dtype", type=str, default="float32",                        help="Torch dtype to use for the model (float32, float16)")
...
@click.option("--opus_dtype", type=str, default="float32",                        help="Torch dtype to use for the model (transformers: float32; Ctranslate2: default, auto, int8, int8_float32, int8_float16, int8_bfloat16, int16, float16, float32, bfloat16)")
# prompts
